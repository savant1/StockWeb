            ...
            <div class="row">
              <div class="col-md-6 col-sm-6">
                <div class="slide-article">
                  <h1 class="wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s">
                      Creative Design & Best Feature
                  </h1>
        ...
        <div class="slide-content">
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-sm-6">
                <div class="slide-article">
                  <h1 class="wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s">ferry Bakongo</h1>
                  <p class="wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.75s">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since</p>
                  <a class="read-more-btn wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s" href="#">Read More</a>
                </div>
              </div>
              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-team-member">
                 ...
                 <div class="team-member-link">
                   <a href="https://www.facebook.com/ferry.francois.bakongo"><i class="fa fa-facebook"></i></a>
                   <a href="https://twitter.com/ferryfrancois17"><i class="fa fa-twitter"></i></a>
                   <a href="https://www.linkedin.com/in/ferryfrancoisbakongo?trk=hp-identity-photo"><i class="fa fa-linkedin"></i></a>
                 </div>
                </div>
              </div>
              <!-- Start single team member -->
